...
/* XXDelay is model specific and therefore implemented in SequencePan.cpp */
/* XXInitialValue is model specific and therefore implemented in SequencePan.cpp */
...
/* XXStopSimulation is implemented in SequencePan.cpp */
